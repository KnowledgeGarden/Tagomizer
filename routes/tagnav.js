 ...
 * tagnav app
 */
var tagNavModel = require('../apps/tagnav/tagnavmodel'),
...
exports.plugin = function(app, environment, ppt, isPrivatePortal) {
	var myEnvironment = environment,
        ...
        TagNavModel = new tagNavModel(environment);
	...
	// Menu
	/////////////////
	environment.addApplicationToMenu("/tagnav","Tag Navigation");
	...
	app.post('/tag/add', isPrivate, function tagPostAdd(req, res) {
		...
		TagNavModel.addTagsToNode(body,usx,credentials, function tagAddTags(err, data) {
...
//		  myEnvironment.logDebug("BLOG INDEX "+start+" "+count+" "+isNext);
		  ...
		  TagNavModel.fillDatatable(start, count, credentials, function tagFillTable(data, countsent, totalavailable) {
	...
	app.post('/tag', isPrivate, function tagPost(req, res) {
	    ...
	    var usx = req.user;
		var credentials = usx.credentials;
	    TagNavModel.update(body, usx, credentials, function tagUpdate(err, result) {
